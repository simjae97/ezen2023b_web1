...
public class Example {
    public static void main(String[] args) {
        ...
        // ===========리스트 순회 ======================//
        System.out.println("일반리스트 순회");
        for (int i = 0; i < list.size(); i++) {
            System.out.println(list.get(i));
        }
        //2.향상된 포문 : 리스트내 순차적으로 하나씩 반복변수에 대입
        System.out.println("리스트 향상된 for문 순회");
        for (Board i : list){
        ...
        System.out.println("arraylist 걸린ㅅ기간 " +(endTime-startTime));
        ...
        endTime = System.nanoTime();
        System.out.println("linkedlist 걸린ㅅ기간 " +(endTime-startTime));
    }
}
